...
<?php 
    ...
    if(isset($_GET['id'])){
        ...
        $sql_getentrant = "SELECT * FROM entrants where id = $id;";
        $entrant = mysqli_query($mydb, $sql_getentrant);
        $values = mysqli_fetch_array($entrant);
        ...
        $id_next = (int)((mysqli_fetch_array(mysqli_query($mydb, $get_id)))[0])+1;
    }
...
<body>
    ...
    <div id = "info">
            <?php
                $entrants = mysqli_query($mydb, "SELECT * FROM entrants");
                $entrants = mysqli_fetch_all($entrants);
                if ($entrants) {
                    ...
                    echo "<table>";
                        ...
                        foreach($entrants as $entrant) {
                            echo "<tr>";
                                ...
                                foreach($entrant as $i => $value) {
                                    if($i >= 11 and $i <= 14) {
                                        if($value==0) $value = 'Нет';
                                        else $value = 'Да';                                     
                                    } else if($i == 9 and !$value) $value = 'Не загружен';
                                    echo "<td>$value</td>";
                                };
